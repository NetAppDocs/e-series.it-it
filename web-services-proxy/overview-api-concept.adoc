...
image::../media/web_services_proxy_api.gif[api proxy dei servizi web]
...
GitHub contiene un repository per la raccolta e l'organizzazione di script di esempio che illustrano l'utilizzo dell'API dei servizi web NetApp SANtricity. Per accedere al repository, vedere https://github.com/NetApp/webservices-samples["Esempi di NetApp WebServices"^].
