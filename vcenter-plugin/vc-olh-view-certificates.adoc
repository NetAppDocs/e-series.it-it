...
. Per visualizzare maggiori informazioni su un certificato, selezionare la riga corrispondente, selezionare i puntini di sospensione alla fine della riga e quindi fare clic su *Visualizza* o *Esporta*.
