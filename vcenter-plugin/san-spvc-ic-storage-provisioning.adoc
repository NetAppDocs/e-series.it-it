...
Per creare un datastore in vSphere Client, consultare il seguente argomento in VMware Doc Center:

* https://docs.vmware.com/en/VMware-vSphere/6.0/com.vmware.vsphere.hostclient.doc/GUID-7EB0CE06-02DD-4B31-85C7-E54993CC06DC.html["Creare un datastore VMFS nel client vSphere"^]
...
. Una volta completata la capacità del volume, è necessario aumentare manualmente le dimensioni VMFS in modo che corrispondano, come descritto nel seguente argomento:
+
** https://docs.vmware.com/en/VMware-vSphere/6.0/com.vmware.vsphere.hostclient.doc/GUID-B0D89816-02E5-4C42-AAFC-19751800A284.html["Aumentare la capacità del datastore VMFS nel client vSphere"^]
...
. Quindi, assegnare i volumi all'host desiderato per aumentare la capacità del datastore. Consultare il seguente argomento:
+
** https://docs.vmware.com/en/VMware-vSphere/6.0/com.vmware.vsphere.hostclient.doc/GUID-B0D89816-02E5-4C42-AAFC-19751800A284.html["Aumentare la capacità del datastore VMFS nel client vSphere"^]
