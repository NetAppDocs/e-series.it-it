...
. Se si apre la finestra di dialogo Resolve Self-Signed Certificates, esamina le informazioni visualizzate relative ai certificati non attendibili. Per ulteriori informazioni, puoi anche fare clic sui puntini di sospensione all'estremità della tabella e selezionare *View* dal menu a comparsa.
. Effettuare una delle seguenti operazioni:
+
