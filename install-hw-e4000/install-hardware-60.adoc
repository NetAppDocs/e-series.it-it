...
CAUTION: Uno scaffale vuoto pesa circa 134 lb (61 kg). Per spostare uno scaffale vuoto in sicurezza è necessario un carrello elevatore meccanizzato o quattro persone che utilizzino le maniglie di sollevamento.
