...
summary: Per SLES 12, si crea un file system nello spazio dei nomi e si monta il file system. 
---
= Creazione di filesystem in E-Series - Linux SLES 12 (NVMe su InfiniBand)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per SLES 12, si crea un file system nello spazio dei nomi e si monta il file system.
