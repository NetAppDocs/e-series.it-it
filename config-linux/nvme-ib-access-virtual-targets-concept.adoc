...
summary: 'Configurare l"i/o diretto alla destinazione del dispositivo in base alla versione di SLES in uso (versione di SUSE Linux).' 
---
= Accesso ai volumi NVMe per destinazioni di dispositivi virtuali in e-Series - Linux (NVMe over InfiniBand)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Per SLES 12, l'I/O viene indirizzato alle destinazioni dei dispositivi virtuali dall'host Linux. DM-MP gestisce i percorsi fisici sottostanti queste destinazioni virtuali.
