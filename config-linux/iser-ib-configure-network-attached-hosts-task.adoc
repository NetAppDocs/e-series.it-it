...
+
*Red Hat Enterprise Linux 8, 9 e 10 (RHEL 8, RHEL 9 e RHEL 10)*
...
----
+
*SUSE Linux Enterprise Server 12, 15 e 16 (SLES 12, SLES 15 e SLES 16)*
...
iscsiadm -m session
----
.. Verificare lo stato della sessione iSCSI dall'array. Da SANtricity System Manager, accedere a *Impostazioni* > *Sistema* > *Visualizza/Termina sessioni iSCSI*.
