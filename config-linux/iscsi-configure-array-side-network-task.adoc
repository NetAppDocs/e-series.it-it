...
Questa procedura descrive come accedere alla configurazione della porta iSCSI dalla pagina Hardware di System Manager. È inoltre possibile accedere alla configurazione dal menu:System[Settings > System > Configure iSCSI ports].
