...
.Prima di iniziare
È necessario eseguire il sistema operativo RHEL 8, RHEL 9, SUSE Linux Enterprise Server 12 o 15 Service Pack compatibile più recente. Per un elenco completo dei requisiti più recenti, consulta la https://mysupport.netapp.com/matrix["Tool di matrice di interoperabilità NetApp"^] sezione.
