...
.Prima di iniziare
È necessario utilizzare il sistema operativo compatibile con il service pack RHEL 8, RHEL 9, RHEL 10, SLES 12, SLES 15 o SLES 16 più recente. Vedi il https://mysupport.netapp.com/matrix["Tool di matrice di interoperabilità NetApp"^] per un elenco completo dei requisiti più recenti.

.Fasi
. Installare i pacchetti rdma e nvme-cli:
+
*SLES 12, SLES 15 o SLES 16*
...
NOTE: Gli script di rete non sono disponibili per RHEL 10.
