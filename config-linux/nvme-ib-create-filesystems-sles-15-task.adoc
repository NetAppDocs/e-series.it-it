...
---
= Creare file system in E-Series - Linux RHEL 8, RHEL 9, RHEL 10, SLES 15 e SLES 16 (NVMe su InfiniBand)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Per RHEL 8, RHEL 9, RHEL 10, SLES 15 e SLES 16, si crea un file system sul dispositivo nvme nativo e si monta il file system.
