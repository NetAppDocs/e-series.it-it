...
. Al termine del controllo dello stato di salute, puoi fare clic sull'ellissi (...) a destra di ciascuna riga per visualizzare ulteriori informazioni ed eseguire altre operazioni.
+
