...
--
Per informazioni sull'installazione dei nuovi controller EF80 e EF50, consultare link:https://docs.netapp.com/us-en/e-series/maintenance-ef50-ef80/controller-replace-move-hardware.html#step-7-install-the-controller["EF50 e EF80 - Fase 7: Installare il controller"^].
