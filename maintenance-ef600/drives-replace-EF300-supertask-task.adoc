...
[role="lead"]
È possibile sostituire un'unità in un array EF300 o EF300C.

EF300 e EF300C supportano l'espansione SAS con shelf da 24 e 60 dischi. La procedura da seguire dipende dal fatto che si disponga di uno shelf da 24 dischi o di uno shelf da 60 dischi:
...
+
image::../media/drw_drive_latch_maint-e5700.gif[Fermo dell'unità]
...
+
image::../media/2860_dwg_attn_led_on_drawer_maint-e5700.gif[LED di attenzione]
...
+
image::../media/2860_dwg_amber_on_drive_maint-e5700.gif[LED attenzione sul cassetto dell'unità]
...
+
image::../media/28_dwg_e2860_de460c_attention_led_drive_maint-e5700.gif[LED attenzione sull'impugnatura dell'unità]
...
+
image::../media/trafford_drive_rel_button_maint-e5700.gif[Dispositivo di chiusura arancione]
...
+
image::../media/92_dwg_de6600_install_or_remove_drive_maint-e5700.gif[Utilizzare la maniglia della camma per sollevare l'unità dal ripiano]
