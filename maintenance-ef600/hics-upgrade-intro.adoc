...
. Da SANtricity System Manager, selezionare menu:Storage[Operations in Progress]. Attendere il completamento di tutte le operazioni prima di procedere con il passaggio successivo.
