...
NOTE: Le seguenti informazioni non si applicano a tutti i sistemi storage, per il cablaggio host specifico del tuo sistema storage, consulta link:../getting-started/getup-run-concept.html["Guida rapida per e-Series"^] e fai clic sul link relativo al tuo sistema storage.
