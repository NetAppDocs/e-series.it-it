...
---
= Cablaggio di alimentazione del sistema storage - E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Accendere entrambi gli alimentatori.
+

NOTE: A seconda del sistema storage, gli alimentatori sono dotati di interruttori di alimentazione oppure non sono presenti interruttori di alimentazione e in tal caso è necessario collegare i cavi di alimentazione per accenderli.
