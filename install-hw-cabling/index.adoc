...
---
= Cablaggio del sistema storage - E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Se il tuo chassis controller (sistema storage) non è presente nell'elenco sottostante, consulta link:../getting-started/getup-run-concept.html["Guida rapida per e-Series"^] e fai clic sul link relativo al tuo specifico sistema storage per accedere alle informazioni sul cablaggio.
...
Se stai eseguendo il cablaggio per una delle seguenti configurazioni, consulta https://mysupport.netapp.com/ecm/ecm_download_file/ECMLP2859057["Aggiunta di shelf di dischi IOM a uno shelf di controller E27XX, E56XX o EF560 esistente."^]
