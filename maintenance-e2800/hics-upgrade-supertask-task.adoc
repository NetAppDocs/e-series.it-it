...
summary: 'Aggiornare una scheda di interfaccia host (HIC) in un array E2800.' 
---
= Aggiornare la scheda di interfaccia host (HIC) - E2800
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/28_dwg_2800_controller_attn_led_maint-e2800.gif[LED cache attiva]
...
+
image::../media/28_dwg_e2800_hic_faceplace_screws_maint-e2800.gif[Rimuovere la piastra anteriore dell'HIC dalla centralina]
...
+
image::../media/28_dwg_e2800_hic_thumbscrews_maint-e2800.gif[Rimuovere l'HIC dalla centralina"]
...
+
image::../media/28_dwg_e2800_hic_faceplace_screws_maint-e2800.gif[Ricollegare la mascherina HIC al controller]
...
+
image::../media/28_dwg_e2800_hic_thumbscrews_maint-e2800.gif[Montare l'HIC nella centralina]
...
+
image::../media/28_dwg_e2860_add_controller_canister_maint-e2800.gif[Rimontare il filtro a carboni attivi della centralina]
