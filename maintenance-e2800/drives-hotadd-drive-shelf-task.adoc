...
---
= Aggiunta a caldo di uno shelf di dischi (IOM12 o IOM12B moduli - E2800 TB)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
.. Selezionare menu: Hardware[Controllers and components].
...
. In SANtricity System Manager, fare clic su menu:Hardware[Controllers and components].
+
...
. In SANtricity System Manager, fai clic su menu:Hardware[Controllers and components] e scorri verso il basso, se necessario, per visualizzare il nuovo drive shelf.
