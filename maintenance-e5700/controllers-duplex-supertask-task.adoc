...
+
image::../media/e5700_mac_address_and_fru_part_number.png[indirizzo mac e5700 e codice fru]
...
.. Individuare lo shelf del controller, contrassegnato dall'icona del controller image:../media/sam1130_ss_hardware_controller_icon_maint-e5700.gif[""].
...
. Se necessario, ridistribuire tutti i volumi al proprietario preferito.
+
.. Selezionare menu:Storage[Volumes] (Storage[volumi]).
.. Selezionare il menu:More[redistribuisci volumi].


. Fare clic su menu:hardware[supporto > Centro aggiornamenti] per verificare che sia installata la versione più recente del software SANtricity OS (firmware del controller).
+
