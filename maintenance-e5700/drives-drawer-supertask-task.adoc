...
---
= Sostituire il cassetto dell'unità - E5700 (60 unità)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/28_dwg_e2860_de460c_fan_canister_handle_with_callout_maint-e5700.gif[Marrone arancione per rilasciare la maniglia del contenitore della ventola]
...
+
image::../media/trafford_cable_rail_1_maint-e5700.gif[Catena portacavi e connettori per il cassetto di azionamento]
...
+
image::../media/trafford_cable_rail_3_maint-e5700.gif[Anello arancione per guida verticale e catena portacavi per cassetto di azionamento]
...
+
image::../media/trafford_cable_rail_2_maint-e5700.gif[Anello arancione per guida orizzontale e catena portacavi per cassetto di azionamento]
...
+
image::../media/dwg_trafford_drawer_with_hdds_callouts_maint-e5700.gif[Numeri degli slot delle unità]
...
+
image::../media/92_dwg_de6600_install_or_remove_drive_maint-e5700.gif[Utilizzare le maniglie delle camme per rimuovere l'azionamento]
...
+
image::../media/92_pht_de6600_drive_drawer_release_lever_maint-e5700.gif[Rilasciare la leva per rimuovere il cassetto]
...
+
image::../media/92_pht_de6600_lock_out_tumbler_detail_maint-e5700.gif[Serratura e guida del cassetto]
...
+
image::../media/2860_dwg_both_guide_rails_maint-e5700.gif[Guide orizzontali e verticali]
...
+
image::../media/28_dwg_e2860_de460c_drive_cru_maint-e5700.gif[Il pulsante sollevato sul supporto dell'unità deve corrispondere al canale dell'unità sul cassetto dell'unità]
...
+
image::../media/92_dwg_de6600_install_or_remove_drive_maint-e5700.gif[Utilizzare la maniglia per abbassare l'unità sul cassetto]
