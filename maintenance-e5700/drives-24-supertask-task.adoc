...
summary: Sostituire un disco in uno shelf da 24 dischi E5700. 
---
= Sostituzione dell'unità - E5700 (shelf da 24 dischi)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/drw_drive_latch_maint-e5700.gif[Premere il pulsante di rilascio per rimuovere l'unità guasta]
