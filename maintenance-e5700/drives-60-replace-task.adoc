...
---
= Sostituzione dell'unità - E5700 (shelf da 60 dischi)
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
Questa attività si applica agli shelf di unità DCM, DCM2 e DCM3.
...
+
image::../media/28_dwg_e2860_de460c_attention_led_drive_maint-e5700.gif[LED attenzione sul cassetto dell'unità]
...
+
image::../media/trafford_drive_rel_button_maint-e5700.gif[Fermo di rilascio arancione per rimuovere l'unità]
...
+
image::../media/92_dwg_de6600_install_or_remove_drive_maint-e5700.gif[Utilizzare la maniglia della camma per rimuovere l'unità]
