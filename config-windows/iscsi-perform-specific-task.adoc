...
* Due reti separate per un'elevata disponibilità. Assicurati di isolare il traffico iSCSI in segmenti di rete separati dagli altri tipi di traffico utilizzando VLAN o due reti separate.
...
Questa procedura descrive come accedere alla configurazione della porta iSCSI dalla pagina Hardware. È possibile accedere alla configurazione anche dal menu: Settings [System > Configure iSCSI ports].
