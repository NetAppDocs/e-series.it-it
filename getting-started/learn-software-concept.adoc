...
Unified Manager è un software basato sul web utilizzato per gestire l'intero dominio. Da una visualizzazione centrale, puoi vedere lo stato di tutti i più recenti array E-Series ed EF-Series, come EF50, EF80, E4000, E2800, EF280, EF300, E5700, EF570, EF600, EF300C ed EF600C. Puoi anche eseguire operazioni batch sugli array di storage selezionati.
...
L'interfaccia a riga di comando (CLI) è un'applicazione software che consente di configurare e monitorare gli array di storage. Utilizzando la CLI, è possibile eseguire comandi da un prompt del sistema operativo, come il  `DOS C:` prompt, un percorso del sistema operativo Linux o un percorso del sistema operativo Solaris.
