...
Per installare l'E-Series hardware, consultare le istruzioni di installazione e configurazione relative al proprio storage array e al tipo di shelf (se applicabile):

[role="quick-margin-list"]
* link:../install-hw-ef50-ef80/install-workflow.html["sistema storage EF50 o EF80"^]
...
[role="quick-margin-list"]
* https://docs.netapp.com/us-en/e-series-santricity/system-manager/index.html["SANtricity System Manager Guida in linea per 12.0x"^]
* https://docs.netapp.com/us-en/e-series-santricity-119/system-manager/index.html["Guida in linea di Gestore di sistema SANtricity per 11.9x"^]
