...
summary: Sostituire il controller danneggiato nel sistema storage EF50 o EF80 rimuovendo il controller, trasferendo i componenti sul controller di ricambio e installando il controller di ricambio. 
---
= Sostituire il controller - EF50 e EF80
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Sostituire il controller danneggiato nel sistema storage EF50 o EF80 verificando che tutti i dati presenti nella cache siano stati scritti sulle unità, scollegare tutti i cavi dal controller danneggiato, rimuovere il controller danneggiato, trasferire i componenti sul controller sostitutivo e installare il controller sostitutivo.
...
Dopo aver sostituito il controller danneggiato, link:controller-replace-online-controller.html["online il controller di ricambio"].
