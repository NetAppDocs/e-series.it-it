...
* https://www.netapp.com/us/media/tr-4789.pdf["Guida alla configurazione VMware per l'integrazione iSCSI di e-Series SANtricity con ESXi 6.X."^] -- fornisce dettagli tecnici sull'integrazione iSCSI con VMware.
* https://configmax.vmware.com/home["Massimi di configurazione VMware"^] -- descrive come configurare lo storage fisico e virtuale in modo che rimanga entro i limiti massimi consentiti supportati da ESX/ESXi.
