...
[role="lead"]
È necessario sostituire la batteria interessata nell'appliance E4000 se il guru del ripristino in Gestione sistema SANtricity indica lo stato "batteria guasta" o "Sostituzione batteria richiesta". Per proteggere i dati, la batteria deve essere sostituita il prima possibile.
