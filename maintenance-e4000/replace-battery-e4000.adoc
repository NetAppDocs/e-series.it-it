...
... Se il grafico mostra le unità, selezionare *Controller & Components* per visualizzare i controller
...
+
.. Seleziona *Storage › Volumi*. Dalla pagina *All Volumes*, verifica che i volumi siano distribuiti ai rispettivi proprietari. Seleziona *More › Change ownership* per visualizzare i proprietari dei volumi
.. Se tutti i volumi sono di proprietà del proprietario preferito, procedere al passaggio 4.
