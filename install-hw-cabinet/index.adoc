...
---
= Installare i vassoi nell'armadio 3040 40U - E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
È possibile installare i seguenti alloggiamenti per unità controller e alloggiamenti per unità di espansione nel cabinet E-Series 3040 da 40U.

Se i cassetti per le unità controller o per le unità di espansione non sono elencati di seguito, vedere  https://hwu.netapp.com["NetApp Hardware Universe"^] per verificare se i cassetti per le unità controller o per le unità di espansione sono supportati.
